...
if (day == "monday") {
    if (budget <= 500) {
        ...
        console.log("Premium package: Order 5 pizzas + 5 chicken roll + 5 drinks. ");
    }
} else if (day == "tuesday") {
    if (budget <= 500) {
    ...
    if (budget <= 500) {
        ...
        console.log("Premium package: Order 2 large pizza + 3 large fries + dessert(three milk cake)");
    }
} else {
    console.log("Aapke din ke liye koi special deal nahi hai.");
}